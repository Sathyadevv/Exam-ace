    ...
    <div class="question-container">
        ...
        <div class="answers">
            ...
            <ol>
                ...
                <li><input type="radio" class="answer" name="answer" id="2"><label for="2">2.{obj[qNo].option[1]}</label></li>
                <li><input type="radio" class="answer" name="answer" id="3"><label for="3">3.{obj[qNo].option[2]}</label></li>
                <li><input type="radio" class="answer" name="answer" id="4"><label for="4">4.{obj[qNo].option[3]}</label></li>
            </ol>
        </div>
    </div>
    ...
    <div class="result">
          ...
          <div class="questions">
            ...
            <div class="results">
                ...
                {#if selectedAnswers[0]==result.question[0].ans}
                   <h5 style="color: #57b973;">Your Answer : {result.question[0].option[selectedAnswers[0]]}</h5>
                {/if}
                {#if selectedAnswers[0]=='Not-Selected'}
                <h5 style="color: red;">You did't select Any answer.</h5>
                {/if}
                {#if !selectedAnswers[0]==result.question[0].ans}
                   <h5 style="color: red;">Your Answer : {result.question[0].option[selectedAnswers[0]]}</h5>
                {/if}
                <h5 class="answer">Correct answer :{result.question[0].option[result.question[0].ans]}</h5>
        ...
        <div class="questions">
            ...
            <div class="results">
                ...
                <h5 style="color: #57b973;">Your Answer : {result.question[1].option[selectedAnswers[1]]}</h5>
                {/if}
                {#if selectedAnswers[1]=='Not-Selected'}
                <h5 style="color: red;">You did't select Any answer.</h5>
                {/if}
                {#if !selectedAnswers[1]==result.question[1].ans}
                   <h5 style="color: red;">Your Answer : {result.question[1].option[selectedAnswers[1]]}</h5>
                {/if}
                <h5 class="answer">Correct answer :{result.question[1].option[result.question[1].ans]}</h5>
        ...
        <div class="questions">
            ...
            <div class="results">
                ...
                <h5 style="color: #57b973;">Your Answer : {result.question[2].option[selectedAnswers[2]]}</h5>
                {/if}
                {#if selectedAnswers[2]=='Not-Selected'}
                <h5 style="color: red;">You did't select Any answer.</h5>
                {/if}
                {#if !selectedAnswers[2]==result.question[2].ans}
                   <h5 style="color: red;">Your Answer : {result.question[2].option[selectedAnswers[2]]}</h5>
                {/if}
                <h5 class="answer">Correct answer :{result.question[2].option[result.question[2].ans]}</h5>
        ...
        <div class="questions">
            ...
            <div class="results">
                ...
                <h5 style="color: #57b973;">Your Answer : {result.question[3].option[selectedAnswers[3]]}</h5>
                {/if}
                {#if selectedAnswers[3]=='Not-Selected'}
                <h5 style="color: red;">You did't select Any answer.</h5>
                {/if}
                {#if !selectedAnswers[3]==result.question[3].ans}
                   <h5 style="color: red;">Your Answer : {result.question[3].option[selectedAnswers[3]]}</h5>
                {/if}
                <h5 class="answer">Correct answer :{result.question[3].option[result.question[3].ans]}</h5>
        ...
        <div class="questions">
            ...
            <div class="results">
                ...
                <h5 style="color: #57b973;">Your Answer : {result.question[4].option[selectedAnswers[4]]}</h5>
                {/if}
                {#if selectedAnswers[4]=='Not-Selected'}
                <h5 style="color: red;">You did't select Any answer.</h5>
                {/if}
                {#if !selectedAnswers[4]==result.question[4].ans}
                   <h5 style="color: red;">Your Answer : {result.question[4].option[selectedAnswers[4]]}</h5>
                {/if}
                <h5 class="answer">Correct answer :{result.question[4].option[result.question[4].ans]}</h5>
