<div class="section-2 containerr">
    <h2>Choose Your Package</h2>
    <div class='underline'></div>
    <div class="package-container">
        <div class="package package-1">
            <div class="icon">
                <svg xmlns="http://www.w3.org/2000/svg" width="50" height="50" fill="#fff" class="bi bi-sd-card" viewBox="0 0 16 16">
            ...
            <p>Lorem ipsum, dolor sit amet consectetur adipisicing elit. Nam tenetur veritatis dicta, sunt magni id.</p>
            <a href="#">BUY NOW</a>
        </div>
        <div class="package package-2">
            <div class="icon">
                <svg xmlns="http://www.w3.org/2000/svg" width="50" height="50" fill="#fff" class="bi bi-globe" viewBox="0 0 16 16">
...
<style lang="scss">
    ...
    .section-2 .package-container {
        display: grid;
        grid-gap: 1.4rem;
        grid-template-columns: repeat(4,1fr);
    }
    .section-2 .package-container .package {
    ...
    .section-2 .package-container .package:hover {
    ...
    .section-2 .package-container .package a {
    ...
    .section-2 .package-container .package a:hover {
        opacity: 0.86;
    }
